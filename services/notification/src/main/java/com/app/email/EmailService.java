...
public class EmailService {
    ...
    @Async//As we are receiving a notification and sending an email, we don't want to block the whole process
    //until the email is sent. We need to enable async in Application file as well
